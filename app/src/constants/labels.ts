export const LABELS = {
  ...
  APP_TITLE: "Jet Governance - Referendum",
  ...
  WELCOME_PARAGRAPH_WITH_REWARDS: "Welcome to Jet Govern—the governance app for Jet Protocol. Here, you earn rewards and help\n"+
  ...
  ACCESS_GRANTED_1_PARAGRAPH_WITH_REWARDS: "To begin, make sure you have some JET tokens staked. Once they are staked, you will begin\n" +
    "earning rewards and may vote on active proposals",


  WELCOME_TITLE_NO_REWARDS: "Stake your JET to start voting today!",
  WELCOME_PARAGRAPH_NO_REWARDS: "Welcome to Jet Govern—the governance app for Jet Protocol. Here, you help\n" +
    "pilot the direction of Jet Protocol by staking your JET into the app.",

  ACCESS_GRANTED_1_TITLE_NO_REWARDS: "Stake JET to vote!",
  ACCESS_GRANTED_1_PARAGRAPH_NO_REWARDS: "To begin, make sure you have some JET tokens staked. Once they are staked, you \n " +
