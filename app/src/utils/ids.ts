...
export let JET_REALM = new PublicKey("BWDXsE7Hp1BSnt5xkew7PEgrcBJgK9C6xPw2YVBcqQqQ");
export let JET_GOVERNANCE = new PublicKey("6ixbhVdFjsCCX8Y6tpv69QpsDofAoNEtU1FAedAj5GTf");
...
export const setProgramIds = (envName: string) => {
  if (envName === "mainnet-beta") {
    ...
    JET_REALM = new PublicKey("BWDXsE7Hp1BSnt5xkew7PEgrcBJgK9C6xPw2YVBcqQqQ");
    JET_GOVERNANCE = new PublicKey("6ixbhVdFjsCCX8Y6tpv69QpsDofAoNEtU1FAedAj5GTf");
