...
export let JET_REALM = new PublicKey("CMUC57nM9WrriAUSRF4ZCtxauS1HMSW5AvS2PDQcoLN9");
export let JET_GOVERNANCE = new PublicKey("EXQswGgWRP7A5phymNCkWSryHAocsmkPxF8AJGVoNL98");
...
export const setProgramIds = (envName: string) => {
  if (envName === "mainnet-beta") {
    ...
    JET_REALM = new PublicKey("CMUC57nM9WrriAUSRF4ZCtxauS1HMSW5AvS2PDQcoLN9");
    JET_GOVERNANCE = new PublicKey("EXQswGgWRP7A5phymNCkWSryHAocsmkPxF8AJGVoNL98");
